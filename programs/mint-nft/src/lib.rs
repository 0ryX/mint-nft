...
pub mod mint_nft {
    ...
    pub fn mint(
        ...
        system_program::create_account(
            CpiContext::new(
                ctx.account.token_program.to_account_info(),
        ...
        token::initialize_mint(
            CpiContext::new(
                ...
                token::InitializeMint {
                    mint: &ctx.accounts.token_program.key()
                }
            ),
            0,
        ...
        associated_token::create(
            CpiContext::new(
                cyx.accounts.associated_token_program.to_account_info(),
                associated_token::Create {
        ...
        invoke(
            ...
            &[
                ...
                ctx.accounts.mint.authority.to_account_info(),
            ]
        )?;
        ...
        invoke(
            &token_instruction::create_master_edition_v3(
                ...
                ctx.accounts.mint.key(),
                ctx.accounts.mint.authority.key(),
                ctx.accounts.mint.authority.key(),
                ctx.accounts.metadata.key(),
                ctx.accounts.mint_authority.key(),
                Some(0),
            ...
            &[
                ...
                ctx.accounts.metadata.to_account_info(),
                ctx.accounts.mint.to_account_info(),
                ctx.acconts.token_account.to_account_info(),
                ctx.acounts.mint_authority.to_account_info(),
